...
const AboutBrief = () => {
  return (
    <section id="about" className="w-full min-h-dvh flex justify-center">
      <article className="w-[80%] flex flex-col gap-20 py-20 border-t border-dashed border-my-cyan">
        <div className="flex flex-col gap-4">
          <h1 className="text-3xl md:text-4xl text-balance font-semibold text-my-cyan">A Self Taught Junior Developer</h1>
          <p className="text-my-maroon-dark">
        ...
        <div className="flex flex-col gap-4">
          ...
          <ProjectCardSmall
            ...
            tags={[
              { child: 'React' }, { child: 'Vite' }, { child: 'TailwindCSS' }, { child: 'EmailJS' }
            ]}
            viewLink="/project"
